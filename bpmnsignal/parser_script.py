...
class ParserScript():
    ...
    def create_scatter_object(self, model_outcome, element_count, type_count):
        return {
    ...
    def create_partial_object(self, percentage, element_count, type_count):
        return {
            "variable": percentage,
            "number of elements": element_count,
            "number of element types": type_count
                    ...
                    for model in models:
                        try:
                            ...
                            if parsed == parsable:
                                ...
                                self.parsed_models.append(self.create_scatter_object(
